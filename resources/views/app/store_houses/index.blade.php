    ...
    <div class="card">
        <div class="card-body">
            <div style="display: flex; justify-content: space-between;">
                <h4 class="card-title">
                    @lang('crud.store_houses.index_title')
                </h4>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-borderless table-hover">
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="width: 134px;">
                                ...
                                >
                                    ...
                                    <a
                                        href="{{ route('store-houses.edit', $storeHouse) }}"
                                    >
                                        <button
                                            type="button"
                                            class="btn btn-light"
                                    ...
                                    @endcan @can('view', $storeHouse)
                                    <a
                                        href="{{ route('store-houses.show', $storeHouse) }}"
                                    >
                                        <button
                                            type="button"
                                            class="btn btn-light"
                                    ...
                                    @endcan @can('delete', $storeHouse)
                                    <form
                                        action="{{ route('store-houses.destroy', $storeHouse) }}"
                                        method="POST"
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="4">{!! $storeHouses->render() !!}</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
